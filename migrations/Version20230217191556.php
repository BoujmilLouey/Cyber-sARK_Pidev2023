 ...
 */
final class Version20230217191556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, id_cours_id INT NOT NULL, id_user_id INT NOT NULL, contenu VARCHAR(255) NOT NULL, INDEX IDX_67F068BC2E149425 (id_cours_id), INDEX IDX_67F068BC79F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
