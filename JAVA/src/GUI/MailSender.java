...
public class MailSender {
    public static void sendMail(coach freelancer) throws Exception{
    ...
    private static Message prepareMessage(Session session, String myAccountEmail, coach freelancer) {
        try{
