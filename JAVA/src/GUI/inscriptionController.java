...
String res="nodata";
    ...
    String maile;
        String value = (String) role.getValue();
           Servicecoach sm =new Servicecoach();
  ...
  if ( value =="Coach" ){
   String ametier = metier.getText() ;
         ...
         Servicecoach sf = new Servicecoach() ;
             coach us = new coach(metier.getText(),nom.getText(), prenom.getText(),Integer.parseInt(cin.getText()),value ,mail.getText(),doHashing(mdp.getText()),adresse.getText(),Integer.parseInt(phone.getText()),pi1,GName.getText()) ;
