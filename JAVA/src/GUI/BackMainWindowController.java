...
public class BackMainWindowController implements Initializable {

    static AnchorPane staticContent;
    private static BackMainWindowController instance;
    ...
    public static BackMainWindowController getInstance() {
        if (instance == null) {
            instance = new BackMainWindowController();
        }
        return instance;
    }
