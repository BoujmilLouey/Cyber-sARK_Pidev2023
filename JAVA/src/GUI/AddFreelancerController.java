...
boolean ok = true;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        public void inflateUI(coach place) {
  ...
  if (phone.getText().length()!=8){
        ...
        coach pv = new coach(anom, aprenom,acin,ametier,role, amail, amdp,adr ,aphone) ; 
         sf.add(pv);
         closeStage();
    }
private void handleEditOperation(){
    coach us = new coach(id ,nom.getText(), prenom.getText(),Integer.parseInt(cin.getText()),metier.getText(),role ,mail.getText(),mdp.getText(),adresse.getText(),Integer.parseInt(phone.getText())) ;
