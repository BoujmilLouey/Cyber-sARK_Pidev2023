...
public class FrontTopBarController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        btnLigne_commandes.setTextFill(COLOR_DARK);

        btnProductss.setTextFill(COLOR_DARK);
    ...
    private void afficherLigne_commandes(ActionEvent event) {
        goToLink(Constants.FXML_FRONT_PANIER);
    ...
    private void afficherProductss(ActionEvent event) {
        goToLink(Constants.FXML_FRONT_DISPLAY_ALL_PRODUCTS);
    ...
    private void goToLink(String link) {
        ...
        FrontMainWindowController.getInstance().loadInterface(link);
    }
