...
public class AffCours implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // Set cell value factories for the table columns
/*
        Ncours.setCellValueFactory(cellData -> {
            Cours cours = cellData.getValue().getId_cours();
            String nomCours = (cours != null) ? cours.getNom() : "";
            return new SimpleStringProperty(nomCours);
        });
