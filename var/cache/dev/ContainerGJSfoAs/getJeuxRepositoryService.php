 ...
 */
class getJeuxRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'JeuxRepository.php';

        return $container->privates['App\\Repository\\JeuxRepository'] = new \App\Repository\JeuxRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
